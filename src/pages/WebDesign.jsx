...
export default function WebDesign() {
  return (
    <div className="w-full h-full">
      <div className="w-full h-full bg-[#18181B] designBk bg-center bg-cover py-10 relative">
          ...
          <div className="w-full h-full flex flex-col lg:flex-row items-center gap-6">
            <div className="w-full  h-full flex flex-col justify-between">
              ...
              >
                ...
                <span className="text-white">/ Web Design Services</span>
              </h1>
              <div style={{ opacity: 1 }}>
                <h1 className="text-[200px] font-extrabold text-purple-950">W</h1>
                <div className="-mt-[106px] md:-mt-[111px] z-10">
                  <h2 className="text-3xl md:text-[40px] text-white font-semibold z-">
                    Web Design
                  </h2>
                  <p className="max-w-[600px] text-base text-white">
                    Professional Web designing services for the online presence
                    your brand deserves. Discover the power of a custom-made,
                    optimized, and world-renowned web design agency.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                <Link to={"/order"}>
                  <div className="w-48 h-12 bg-gradient-to-l from-black to-purple-800  relative group">
                    <button className="w-48 h-12 bg-purple-900 text-black font-titleFont font-semibold text-lg absolute -translate-x-2 -translate-y-2 transform group-hover:bg-reactYellow group-hover:translate-x-0 group-hover:translate-y-0 transition-transform duration-500">
                      Businesss
                    </button>
                  </div>
                </Link>
      ...
      <div className="w-full bg-black py-20 flex flex-col lg:flex-row gap-20 px-4">
        <div className="max-w-4xl mx-auto flex flex-col gap-4">
          <h1 className="text-3xl text-white font-medium underline underline-offset-8 decoration-[1px] decoration-purple-900">
